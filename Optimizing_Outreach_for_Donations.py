# -*- coding: utf-8 -*-
"""
Created on Wed Nov 15 16:47:46 2017
...
ddf_train = pd.read_csv("C:\\Users\\Aditya\Downloads\\Uptake_challenge\\train.csv", usecols=cols_train)
ddf_train_r = pd.read_csv("C:\\Users\\Aditya\Downloads\\Uptake_challenge\\train.csv", usecols=cols_train_r)
ddf_test = pd.read_csv("C:\\Users\\Aditya\Downloads\\Uptake_challenge\\test.csv", usecols=cols_test)
...
X_train, X_test, y_train, y_test = train_test_split(
    X_train, y_train, test_size=0.7, random_state=0)
...
ddf_train = pd.read_csv("C:\\Users\\Aditya\Downloads\\Uptake_challenge\\train.csv")
ddf_train["zip"]=ddf_train["zip"].replace('\-','',regex=True).astype(int)
...
test = pd.read_csv("C:\\Users\\Aditya\Downloads\\Uptake_challenge\\test.csv")
amount = 0.0
sum1 = 0.0
j = 0
